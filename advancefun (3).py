...
# # print(list(map))
# filter = list(filter(lambda x: x**2==121, nums))
# print(filter)
...
Task 22
practice function and advance functions
Task 23
write a python program using atm and calculator
Task 24
...
# multiples = list(generate_multiples(x, n))

# print("List of multiples:", multiples)

# # Now iterate over the list
# for i in multiples:
#     print(f'The multiple is: {i}')
